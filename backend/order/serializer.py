...
class AllOrderSerializer(serializers.ModelSerializer):
  ...
  class Meta:
    model = Order
    fields = ['order_Id','order_Status', 'order_Placment_Date','order_Placment_Time', 'customer','payment','total_Amount']
...
class ProductsSerializer(serializers.ModelSerializer):
  ...
  class Meta:
    model = Product
    fields = ['product_Id', 'product_Name','imageGallery','product_Price', 'image']
...
class OrderPostSerializer(serializers.ModelSerializer):
    class Meta:
      model = Order
      fields = ['order_Status','total_Amount','note','order_Delivery_Date','destination_email']
